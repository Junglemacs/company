...
<div class="container">
    <main id="maincontent" class="middle-align">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-consulting'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php $theme_lay = get_theme_mod( 'vw_consulting_theme_options','Right Sidebar');
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-consulting' ),
                                'next_text'          => __( 'Next page', 'vw-consulting' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-consulting' ) . ' </span>',
                            ) );
                        ?>
