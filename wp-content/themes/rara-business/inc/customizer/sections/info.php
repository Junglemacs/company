...
if ( ! function_exists( 'rara_business_customizer_theme_info' ) ) :
	...
	function rara_business_customizer_theme_info( $wp_customize ) {
	    ...
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'rara-business' ), esc_url( 'https://rarathemes.com/documentation/rara-business/' ), esc_html__( 'Click here.', 'rara-business' ) );
