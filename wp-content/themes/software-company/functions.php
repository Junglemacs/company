...
function rara_business_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'software-company' ), esc_url( 'https://rarathemes.com/documentation/software-company/' ), esc_html__( 'Click here.', 'software-company' ) );
...
function rara_business_customizer_demo_content( $wp_customize ) {
    ...
    $theme_demo_content_desc .= '<span class="sticky_info_row download-link"><label class="row-element">' . __( 'Download Demo Content', 'software-company' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/documentation/software-company/' ) . '" target="_blank">' . __( 'Click here', 'software-company' ) . '</a></span><br />';
